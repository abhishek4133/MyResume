...
<body layout="column" ng-controller="AppCtrl" id="body">
	...
	<div class="container" style="background: #f2f2f2">
		...
		<div class="tabs tabs-style-flip">
			<nav>
			<ul>
				<li><a href="#section-flip-5"><span style="font-size: 23px">About Me</span></a></li>
				<li><a href="#section-flip-4"><span style="font-size: 23px">Professional</span></a></li>
				<li><a href="#section-flip-2"><span style="font-size: 23px">Timeline</span></a></li>
				<li><a href="#section-flip-3"><span style="font-size: 23px">Connection</span></a></li>		
			...
			<div class="content-wrap">
				...
				<div class="content">
					<div class="row">
						...
						<div class="col-md-6">
							<h2 class="section-title">
								<span class="headerFont"><i class="fa fa-flask"></i>WORK</span>
							</h2>
							<div class="fontSize" style="margin-left: 30px;">
								...
								<ul>
									...
									<li><a class="timeline-content timeline-header" href="http://my.adaptiveyou.com" target="_blank">ADAPTIVEYOU</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							...
							<div class="cd-timeline-block">
								...
								<div class="cd-timeline-content" >
									...
									<span class="cd-date date">Feb 04 1990 - May 27 2004</span>
								</div>
								<!-- cd-timeline-content -->
							</div>
				...
				<div class="content">
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="social" align="center">
								<li><a
									href="https://www.facebook.com/abhishek.4133" target="_blank" >
									<img src="img/facebook.svg" ></img></a></li>
								<li><a 
									href="https://google.com/+ABHISHEKKUMAR4133"
									target="_blank"><img src="img/googleplus.svg" id="iconColor"></img></a></li>
								<li><a 
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="row">
						  		<div class="col-lg-12" style="padding-left: 45px; padding-right: 30px">
						  ...
						  <div class="col-md-6">
							<h2 class="section-title">
								<span class="headerFont"><i class="fa fa-envelope"></i>CONTACT</span>
								
							</h2>
							<div class="row">
						  		<div class="col-lg-12" style="padding-left: 60px;padding-right: 30px">
						  			<span style="font-size: 30px">Abhishek kumar</span>	
						  			<br>
						  			<span style="font-size: 16px"><i class="fa fa-at"></i>&nbsp abhishek.4133@gmail.com</span>
						  			<br>
						  			<span style="font-size: 16px">&nbsp<i class="fa fa-map-marker"></i>&nbsp&nbsp chennai</span>
								</div>		
								</div><!-- /input-group -->
						  </div><!-- /.col-lg-6 -->
						</div>
		...
		<!-- /tabs --> </section>
		<div class="footer col-md-12 text-center"><h4 class="copyright">Copyright © 2015 abhishek.work.</h4></div>
	</div>
